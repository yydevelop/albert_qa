...
ALL_MODELS = sum(
    (
        ...
        for conf in (BertConfig, CamembertConfig, RobertaConfig, XLNetConfig, XLMConfig,AlbertConfig)
    ),
    (),
)
...
MODEL_CLASSES = {
    ...
    "albert-japanese-v2": (AlbertConfig.from_pretrained("ALINEAR/albert-japanese-v2"), AlbertForQuestionAnswering.from_pretrained("ALINEAR/albert-japanese-v2"), AlbertTokenizer.from_pretrained("ALINEAR/albert-japanese-v2")),
}
